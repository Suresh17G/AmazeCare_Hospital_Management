...
public class MedicalRecordDetailsDTO {
	...
	public MedicalRecordDetailsDTO(int recordId, int appointmentId, int patientId, String patientFirstName,
			int doctorId, String doctorFirstName, List<PrescriptionDetailsDTO> prescriptions, String symptoms,
