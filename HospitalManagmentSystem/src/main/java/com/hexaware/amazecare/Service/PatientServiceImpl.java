...
public class PatientServiceImpl implements IPatientService{
	...
	public PatientDetailsDTO updateprofile(int id, PatientDTO pd) throws PatientNotFoundException  {
	    ...
	    if(pd.getAllergies()!=null) {
	    	...
	    	existingPatient.setAllergies("None");
	    }
	...
	public List<DoctorDetailsDTO> getAvailableDoctors() {
		logger.info("Request initiated to get all available doctors with Speciality:");
		List<Doctor> doc = doctorRepo.findAll();
		if(doc.isEmpty()) {
			logger.info("No doctors found with Speciality: ");
			return null;
		}
