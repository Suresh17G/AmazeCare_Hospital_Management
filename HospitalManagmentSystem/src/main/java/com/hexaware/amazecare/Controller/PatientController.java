...
public class PatientController {
	...
	@GetMapping("/patient/getAvailableDoctors")
	public ResponseEntity<List<DoctorDetailsDTO>> getAvailableDoctors()throws RecordsNotFoundException, DoctorNotFoundException{
		
		List<DoctorDetailsDTO> doctors = service.getAvailableDoctors() ;
		if (doctors==null) {
