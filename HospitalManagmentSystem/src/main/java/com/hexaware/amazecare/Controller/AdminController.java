...
public class AdminController {
	...
	@PutMapping("/admin/editAppointment/{appointmentid}")
	public ResponseEntity<AppointmentDetailsDTO> cancelAppointment(@RequestBody AppointmentDTO app ,@PathVariable int appointmentid) throws AppointmentNotFoundException{
		
		AppointmentDetailsDTO updated=service.editAppointment(appointmentid,app);
		if(updated==null) {
	...
	public ResponseEntity<List<PrescriptionDetailsDTO>> viewPrescription() throws RecordsNotFoundException{
		List<PrescriptionDetailsDTO> Prescriptions=service.viewAllPrescriptions();
		if(Prescriptions==null) {
			throw new RecordsNotFoundException("No Prescriptions Found!");
		}
