...
public class DoctorController {
	...
	@GetMapping("/doctor/viewPatientHistory/{patientid}")
	...
	@GetMapping("/medicalRecord/viewPrescriptions/{recordId}")
	public ResponseEntity<List<PrescriptionDetailsDTO>> viewPrescriptions(@PathVariable int recordId) throws RecordsNotFoundException {

	    List<PrescriptionDetailsDTO> prescriptions = service.viewPrescriptionsByRecordId(recordId);
	    if (prescriptions.isEmpty()) {
	        throw new RecordsNotFoundException("No prescriptions found for the given medical record.");
	    }
